  ...
  return (
    <section className="lg:flex mx-4 mt-20 gap-3 justify-evenly">
      <div className="lg:w-1/2  p-2">
        ...
        <Image src={'/img1.webp'} width={400} height={200} className='block lg:hidden my-4 h-full w-full' alt='gambar bangunan'/>
        <p className="mb-2">
      ...
      <Image src={'/img1.webp'} width={400} height={200} className='hidden lg:block h-full w-full' alt='gambar bangunan'/>
    </section>
  );
};
