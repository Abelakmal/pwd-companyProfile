...
const Overview5 = () => {
  return (
    <section className="mt-20 text-center bg-gray-300 lg:h-96 max-md:h-full max-md:py-20">
      <h1 className="text-orange-900 font-bold">Our clients</h1>
      ...
      <div className="flex justify-evenly max-md:flex-col m-4  gap-4">
        <div className="h-65 shadow-xl border rounded p-4 bg-white ">
          <p className="border-l-2 border-orange-900 bg-gray-100 opacity-90">
          ...
          <div className="flex mt-4">
            ...
            <div className="text-start ml-4">
              <h3 className="text-orange-800 font-bold">Edward D.Best</h3>
              <p>Business</p>
            </div>
          </div>
        </div>
